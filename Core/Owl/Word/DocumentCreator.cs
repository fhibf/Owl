...
namespace Owl.Word {
    ...
    internal class DocumentCreator {
        ...
        public WordprocessingDocument CreatePackage(string filePath) {
        ...
        private void CreateParts(WordprocessingDocument document) {
            ...
            StyleDefinitionsPart styleDefinitionsPart1 = mainDocumentPart1.AddNewPart<StyleDefinitionsPart>(StyleCreator.StyledefinitionPartId);
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1) {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "0050473A" };
            Rsid rsid1 = new Rsid() { Val = "002C53DD" };
            Rsid rsid2 = new Rsid() { Val = "003A59C6" };
            Rsid rsid3 = new Rsid() { Val = "0050473A" };
            ...
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{7FFAD550-5F95-41F6-BEFD-812EA544F8CE}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1) {
            ...
            Languages languages2 = new Languages() { Val = "pt-BR" };
