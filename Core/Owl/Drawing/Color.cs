...
namespace Owl.Drawing
{
    ...
    public struct Color
    {
        ...
        internal Color(KnownColor knownColor) : this((long)knownColor, StateKnownColorValid, knownColor.ToString(), knownColor)
        { }
        ...
        private static void CheckByte(int value, string name)
        {
            if (value < 0 || value > 255)
                throw new ArgumentException("InvalidEx2BoundArgument", nameof(value));
        }
